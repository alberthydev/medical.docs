...
import { parseParecerMarkdown, ParecerCriterion } from '../utils/parecerParser';

interface MarkdownParecerViewProps {
...
export const MarkdownParecerView: React.FC<MarkdownParecerViewProps> = ({
  markdownContent,
  onCopyNotice,
  onOpenShareModal
}) => {
  ...
  const patientName = parsed.identificacao['Paciente'] || 'Paciente Identificado';
  const cidValue = parsed.identificacao['CID-10'] || parsed.identificacao['CID'] || 'CID-10';
  const drugValue = parsed.identificacao['Medicamento solicitado'] || parsed.identificacao['Medicamento'] || 'Medicamento Solicitado';

  return (
    <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-6 animate-in fade-in duration-300">
      
      {/* TOP EXECUTIVE HEADER (Minimal & Clean) */}
      <header className="bg-white rounded-2xl p-5 sm:p-7 border border-[#e5e2dd] shadow-xs no-print flex flex-col md:flex-row md:items-center justify-between gap-5">
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] text-[#74777d] font-medium hidden sm:inline">
              Auditoria Baseada no PCDT Oficial
            </span>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5 shrink-0">
          ...
          <button
            ...
            title="Exportar ou Imprimir Parecer Técnico em PDF"
          >
            <Printer className="w-4 h-4 text-[#b5f0ca]" />
            <span>Gerar PDF</span>
          </button>

          {/* 2. COPIAR SÍNTESE (Direct for CEAF Dispatch) */}
          <button
            type="button"
          ...
          <button
            ...
            className="h-10 px-3 rounded-xl bg-white hover:bg-[#f6f3ee] text-[#74777d] hover:text-[#0f2137] border border-[#e5e2dd] shadow-xs flex items-center justify-center transition-colors cursor-pointer"
            title="Compartilhar Parecer"
          >
      ...
      {/* FILTER TABS (Minimal Segmented Pill Bar) */}
      ...
      {/* DOCUMENT PAPER WRAPPER (Print-Ready, Clean, High Contrast) */}
      <main className="space-y-6">
        
        {/* ========================================================
            SEÇÃO 1: IDENTIFICAÇÃO (Structured Minimal Grid)
        ======================================================== */}
        ...
        {/* ========================================================
            SEÇÃO 2: ANÁLISE TÉCNICA DETALHADA, PONTO A PONTO
        ======================================================== */}
        {(activeTab === 'all' || activeTab === '2') && (
          <section className="bg-white rounded-2xl p-6 sm:p-8 border border-[#e5e2dd] shadow-xs space-y-5">
            ...
            {/* List of Individual Criterion Cards (Minimal & Separated) */}
            {parsed.analiseCritérios.length > 0 ? (
              <div className="space-y-3.5">
                {parsed.analiseCritérios.map((crit, idx) => {
                  ...
                  const isNaoConforme = crit.situacao === 'nao-conforme';
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Side by side or stacked requirements */}
              ...
              /* Fallback markdown render if not standard criterion format */
        ...
        {/* ========================================================
            SEÇÃO 3: PONTO CRÍTICO (DECISIVO) - High Impact Callout
        ======================================================== */}
        ...
        {/* ========================================================
            SEÇÃO 4: PLANILHA COMPARATIVA (PCDT × PACIENTE)
        ======================================================== */}
        ...
        {/* ========================================================
            SEÇÃO 5: SEGUNDA CONFERÊNCIA (Audit Checklist)
        ======================================================== */}
        ...
        {/* ========================================================
            SEÇÃO 6: CONCLUSÃO FINAL (PCDT como referência)
        ======================================================== */}
        ...
        {/* ========================================================
            SEÇÃO 7: SÍNTESE TÉCNICA (CEAF Dispatch Card)
        ======================================================== */}
        {(activeTab === 'all' || activeTab === '7') && (
          <section className="bg-[#0f2137] text-white rounded-2xl p-6 sm:p-8 border border-[#0f2137] shadow-lg space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-white/10">
              ...
              {/* One-Click Copy Dispatch Button */}
              <button
                type="button"
            ...
            <p className="text-xs text-[#b5c7dd] leading-relaxed">
              Texto padronizado e conciso elaborado para fundamentar o despacho administrativo do CEAF e ser inserido diretamente no prontuário/sistema estadual:
            </p>
      ...
      {/* FOOTER ACTIONS BAR (Minimal, clean, print-hidden) */}
      <footer className="pt-4 border-t border-[#e5e2dd] flex flex-col sm:flex-row items-center justify-between gap-4 no-print text-xs text-[#74777d]">
        <div className="flex items-center gap-1.5">
          ...
          <span>Laudo emitido em conformidade com as diretrizes do Ministério da Saúde.</span>
        </div>
